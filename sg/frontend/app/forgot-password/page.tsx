          ...
          <section className="auth-card">
            ...
            {!sent ? (
              ...
              <>
                ...
                <a className="btn btn-primary btn-block" href={href(`/verify-code?email=${encodeURIComponent(email.trim())}`)}>{t("forgot.enterCode")} <span className="arrow" aria-hidden>→</span></a>
              </>
            )}
